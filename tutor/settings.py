...
OPENAI_BASE_URL = "https://api.deepseek.com"  # DeepSeek's API URL
...
SECRET_KEY = 'django-insecure-ird0cv@gp_4lbmuv$$p3qy8i!s16@t&ieoh_id8zm_qi+pjmdv'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "education_tutor", "static"),  
]
